...
\item Identify a common property of all bases of $\R^n$.   
\item Find coordinates of a vector relative to a basis.  
\end{itemize}


For time budgeting purposes, this sequence has 4 videos totaling 23 minutes, 
plus some questions.  
...
Note that the list $L$ spans a line in $\R^2$, and $L$ is linearly independent, so $L$ forms a basis of that line. 
...
\edXsolution{The list $L$ contains 3 vectors in $\R^2$.  Since $3>2$, $L$ must be linearly dependent and
cannot be a basis of anything.  
}
...
\edXsolution{Since $v$ is a scalar multiple of $w$, $L$ is not linearly independent.  Hence it cannot be a
basis of $\R^2$ or any subspace of $\R^2$.  
