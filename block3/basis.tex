...
\edXsolution{The list $L$ consists of a single vector in $\R^2$.  Thus, $L$ cannot be a basis of $\R^2$, since every such basis has exactly $2$ vectors.  Linear combinations of $v$ are simply scalar multiples of $v$, and the collection of these form a 1-dimensional subspace of $\R^2$.  The list $L$ is the basis for this subspace.
...
\edXsolution{The list $L$ contains 3 vectors.  Every basis of $\R^2$ contains exactly 2 vectors, and a basis of any strict subspace of $\R^2$ contains less than $2$ vectors.  Since $3>2$, $L$ is not a basis of $\R^2$ or any of its subspaces.
...
\edXabox{type="multichoice" expect="$L$ is a basis of $\R^2$" options="$L$ is a basis of $\R^2$","$L$ is a basis of some subspace of $\R^2$, but not of $\R^2$ itself","$L$ is not a basis of any subspace of $\R^2$"}

\edXsolution{Two vectors are linearly independent if and only if they are not scalar multiples of one another.  Thus, $v$ and $w$ span all of $\R^2$.  Since the list $L$ consists of exactly 2 linearly independent vectors in $\R^2$, $L$ is a basis of $\R^2$.
...
\edXsolution{Since $v$ is a scalar multiple of $w$, $v$ and $w$ span a line in $\R^2$.  This line is a one-dimensional subspace, and so any basis of this line must contain exactly one vector.  But, the list $L$ contains 2 vectors.
