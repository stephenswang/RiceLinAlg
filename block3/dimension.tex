...
\beginedxproblem{Review Question}{\dpa3}
...
\edXabox{type="custom" cfn="VectorEntry" expect="[[3],[0],[2],[-1]]"}


\edXsolution{
We can write $w$ as a linear combination of the basis vectors in order:
$w =  3v_1  + 0v_2 + 2v_3 - v_4.$  Hence $[w]_{\mathcal{B}} =\left[\begin{array}{c} 3 \\ 0 \\ 2  \\ -1 \end{array} \right]$.  
...
\beginedxvertical{Coordinatization}
